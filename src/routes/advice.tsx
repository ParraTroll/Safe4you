...
const LETTERS = [
  {
    ...
    a: [
      "First: this is not your fault, and it is fixable. Go straight to Instagram's 'Need more help?' / hacked account. Because the email was changed, they will send a recovery code to your original address or ask you to verify.",
      "While you wait, post from another account or message a group chat telling friends the messages are a scam and not to click anything. That stops the damage spreading or other accounts getting hacked.",
      "Once you are back in, change the password to a long and strong password you use nowhere else, turn on two-factor authentication, and check Settings → Security → Login activity to kick out unknown devices. Finally, change the password on any other account that used the same one.",
    ],
  },
  {
    from: "Nearly Got Me",
    ...
    a: [
      ...
      "Three quick checks: does it create urgency or a tiny fee? Does the link domain look slightly off, like 'auspost-delivery.co'? And were you actually expecting a parcel from that company?",
  ...
  },
  {
    ...
    a: [
      "She has a point, but you do not have to stop posting. The risk is not any single post; it is the pattern you leave behind. Uniform plus suburb plus 'walking home from training' tells a stranger exactly where to find you on a Thursday.",
